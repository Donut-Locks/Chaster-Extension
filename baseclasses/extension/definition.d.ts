import { ExtensionForPublicAvailableModesEnum } from "../../api";

declare class ExtensionDefinition{

    /**
     * Base class to derive a chaster extension for the extension API
     * 
     * Documentation - https://docs.chaster.app/api/extensions-api/getting-started
     * 
     * @param definition The definition of an extension
     */
     ...
     */
    public availableModes?:ExtensionForPublicAvailableModesEnum[];
    /**
